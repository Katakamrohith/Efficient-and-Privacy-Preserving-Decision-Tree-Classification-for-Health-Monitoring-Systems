...
ROOT_URLCONF = 'efficient_and_privacy_preserving.urls'
...
WSGI_APPLICATION = 'efficient_and_privacy_preserving.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'efficient_and_privacy_preserving',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
