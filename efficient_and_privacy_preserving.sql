...
--
-- Host: localhost
-- Generation Time: Feb 28, 2022 at 12:03 PM
...
--
-- Database: `efficient_and_privacy_preserving`
--
CREATE DATABASE IF NOT EXISTS `efficient_and_privacy_preserving` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `efficient_and_privacy_preserving`;
...
(93, 'Naive Bayes', '25.925925925925924'),
(94, 'SVM', '79.62962962962963'),
(95, 'Logistic Regression', '79.62962962962963'),
(96, 'Decision Tree Classifier', '79.62962962962963'),
(97, 'SGD Classifier', '75.92592592592592'),
(98, 'KNeighborsClassifier', '79.62962962962963');
...
(11, 'Good Health', '66.66666666666666'),
(12, 'Bad Health', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_health_monitoring`
--

CREATE TABLE IF NOT EXISTS `remote_user_health_monitoring` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wsrid` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `sex` varchar(300) NOT NULL,
  `cp` varchar(300) NOT NULL,
  `chol` varchar(300) NOT NULL,
  `fbs` varchar(300) NOT NULL,
  `ekg` varchar(300) NOT NULL,
  `hr` varchar(300) NOT NULL,
  `ex_angina` varchar(300) NOT NULL,
  `stdep` varchar(300) NOT NULL,
  `slope` varchar(300) NOT NULL,
  `nov` varchar(300) NOT NULL,
  `thal` varchar(300) NOT NULL,
  `olevel` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_health_monitoring`
--

INSERT INTO `remote_user_health_monitoring` (`id`, `wsrid`, `age`, `sex`, `cp`, `chol`, `fbs`, `ekg`, `hr`, `ex_angina`, `stdep`, `slope`, `nov`, `thal`, `olevel`, `prediction`, `bp`) VALUES
(1, '89df2855-56eb-4706-a23b-b39363dd605a', '70', '1', '4', '322', '0', '2', '109', '0', '2.4', '2', '3', '3', '96', 'Bad Health', '130'),
(2, 'c2d5d102-967c-487d-88f2-8b005a449f3e', '57', '1', '2', '261', '0', '0', '141', '0', '0.3', '1', '0', '7', '98', 'Good Health', '124'),
(3, 'cf272c21-98d8-45c1-9e2b-5ed1fe1864bd', '59', '1', '4', '239', '0', '2', '142', '1', '1.2', '2', '1', '7', '97', 'Good Health', '110');
