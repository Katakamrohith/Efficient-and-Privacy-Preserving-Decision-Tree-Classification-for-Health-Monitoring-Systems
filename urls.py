"""efficient_and_privacy_preserving URL Configuration
...
from efficient_and_privacy_preserving import settings
...
urlpatterns = [
    ...
    url(r'^Find_Health_Monitoring_Prediction/$', remoteuser.Find_Health_Monitoring_Prediction, name="Find_Health_Monitoring_Prediction"),
    ...
    url(r'^Find_Health_Monitoring_Prediction_Ratio/$', serviceprovider.Find_Health_Monitoring_Prediction_Ratio, name="Find_Health_Monitoring_Prediction_Ratio"),
    url(r'^View_Health_Monitoring_Prediction_Details/$', serviceprovider.View_Health_Monitoring_Prediction_Details, name="View_Health_Monitoring_Prediction_Details"),
